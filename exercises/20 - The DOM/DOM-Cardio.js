...
let cardsHTML = generatePlayerCard("matt", 12, 150);

cardsHTML += generatePlayerCard("jess", 15, 150);

cardsHTML += generatePlayerCard("jay", 12, 150);

cardsHTML += generatePlayerCard("sam", 12, 150);
